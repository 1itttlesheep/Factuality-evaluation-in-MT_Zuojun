...
def build_list(filename):
    ...
    with open(filename, 'r', encoding='utf-8') as f:
        ...
        for line in lines:
            ...
            hyp1 = l[2].strip()
            #hyp2 = l[3].strip()
            datalist.append((i, r, hyp1))
        return datalist

def result_print(test, pathh1):
    score1 = {}
    for tuple in test:
        i = tuple[0].strip()
        ...
        if r == hyp1:
            continue
        #hyp2 = tuple[3].strip()
        s1 = nli_score([r], [hyp1])[0]
        #s2 = nli_score([r], [hyp2])[0]
        score1[i] = s1
        #score2[i] = s2
...
if __name__ == '__main__':
    ...
    result_print(build_list('output2/nonword.txt'),'result2/nonnnr.txt')